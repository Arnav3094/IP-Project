...
artists += list(map(str, 'Ed Sheeran,Bastille,Billie Eilish,Duncan Laurence,Dempsey Hope,Christian French,Miley Cyrus,Frank Ocean,Ellie Goulding,Camila Cabello,Alec Benjamin,Bruno Mars,Lauv,Selena Gomez,Maroon 5,Jon Bellion,JP Saxe,Ariana Grande,Justin Bieber,Anson Seabra,Justin Timberlake,Khalid,6LACK,Dean Lewis'.split(',')))
